...
export const employeesLeaves = sqliteTable('employees_leaves', {
...
export const employeesAttendances = sqliteTable('employees_attendances', {
...
export const employeesCredentials = sqliteTable('employees_credentials', {
...
export const employeesActivities = sqliteTable('employees_activities', {
...
export const employeesSalaries = sqliteTable('employees_salaries', {
...
export const organizationsPayments = sqliteTable('organizations_payments', {
...
export const clientsPayments = sqliteTable('clients_payments', {
...
/*
 ...
 leaves      : one(employeesAttendances, {
 fields    : [ employees.employee_id ],
 references: [ employeesAttendances.employee_attendance_employee_id ],
 }),
 salary      : one(employeesSalaries, {

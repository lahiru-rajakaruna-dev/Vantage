...
export const EPGActivityType = pgEnum(
    'EActivityType',
    [
        'SALE_INITIALIZED',
        'SALE_CLOSED',
...
export const SchemaEmployeeAttendanceInsert = createInsertSchema(employeesAttendances)
...
export const SchemaEmployeeAttendanceUpdate = createUpdateSchema(employeesAttendances)
    .omit({
              employee_attendance_id             : true,
              employee_attendance_employee_id    : true,
              employee_attendance_organization_id: true
          });
export const SchemaEmployeeAttendanceSelect = createSelectSchema(employeesAttendances)
...
export const SchemaEmployeeActivityInsert = createInsertSchema(employeesActivities)
    .extend({
                ...
                employee_activity_longitude : z.number()
                                               ...
                                               .max(180)
                                               .optional(),
                employee_activity_ip_address: z.ipv4()
                                               .optional()
            })
...
export const SchemaEmployeeActivityUpdate = createUpdateSchema(employeesActivities)
    .extend({
                employee_activity_timestamp : z.number()
                                               .int()
                                               .positive()
...
export const SchemaEmployeeActivitySelect = createSelectSchema(employeesActivities)
    .extend({
                employee_activity_timestamp: z.number()
                                              .int(),
                employee_activity_message  : z.string(),
...
export const SchemaEmployeeCredentialsInsert = createInsertSchema(employeesCredentials)
...
export const SchemaEmployeeCredentialsUpdate = createUpdateSchema(employeesCredentials)
    .omit({
              employee_credential_id             : true,
              employee_credential_employee_id    : true,
              employee_credential_organization_id: true
          });
export const SchemaEmployeeCredentialsSelect = createSelectSchema(employeesCredentials)
...
export const SchemaOrganizationPaymentInsert = createInsertSchema(organizationsPayments)
...
export const SchemaOrganizationPaymentUpdate = createUpdateSchema(organizationsPayments)
    .omit({
              organization_payment_id             : true,
              organization_payment_organization_id: true
          });
export const SchemaOrganizationPaymentSelect = createSelectSchema(organizationsPayments)

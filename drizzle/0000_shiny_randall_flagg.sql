...
(
    ...
    `organization_paddle_customer_id`    text                  NOT NULL,
...
CREATE UNIQUE INDEX `organizations_organization_paddle_customer_id_unique` ON `organizations` (`organization_paddle_customer_id`);--> statement-breakpoint
...
CREATE TABLE `employees_salary_profiles`
(
    `employee_salary_profile_id`                    text              NOT NULL,
    `employee_salary_profile_organization_id`       text              NOT NULL,
    `employee_salary_profile_employee_id`           text              NOT NULL,
    `employee_salary_profile_base`                  real              NOT NULL,
    `employee_salary_profile_commission_percentage` integer DEFAULT 0 NOT NULL,
    PRIMARY KEY (`employee_salary_profile_id`, `employee_salary_profile_organization_id`,
                 `employee_salary_profile_employee_id`),
    FOREIGN KEY (`employee_salary_profile_employee_id`,
                 `employee_salary_profile_organization_id`) REFERENCES `employees` (`employee_id`, `employee_organization_id`) ON UPDATE no action ON DELETE no action,
    FOREIGN KEY (`employee_salary_profile_organization_id`) REFERENCES `organizations` (`organization_id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
CREATE INDEX `employee_salary_profile_id_idx` ON `employees_salary_profiles` (`employee_salary_profile_id`);--> statement-breakpoint
CREATE INDEX `employee_salary_profile_organization_id_fk_idx` ON `employees_salary_profiles` (`employee_salary_profile_organization_id`);--> statement-breakpoint
CREATE INDEX `employee_salary_profile_employee_id_fk_idx` ON `employees_salary_profiles` (`employee_salary_profile_employee_id`);--> statement-breakpoint
CREATE TABLE `employees_syncs`
(
    `employee_sync_id`                    text    NOT NULL,
    `employee_sync_organization_id`       text    NOT NULL,
    `employee_sync_employee_id`           text    NOT NULL,
    `employee_sync_last_synced_timestamp` integer NOT NULL,
    PRIMARY KEY (`employee_sync_id`, `employee_sync_organization_id`, `employee_sync_employee_id`),
    FOREIGN KEY (`employee_sync_organization_id`) REFERENCES `organizations` (`organization_id`) ON UPDATE no action ON DELETE no action,
    FOREIGN KEY (`employee_sync_employee_id`, `employee_sync_organization_id`) REFERENCES `employees` (`employee_id`, `employee_organization_id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
CREATE UNIQUE INDEX `employees_syncs_employee_sync_id_unique` ON `employees_syncs` (`employee_sync_id`);--> statement-breakpoint
CREATE INDEX `employee_sync_organization_id_idx` ON `employees_syncs` (`employee_sync_organization_id`);--> statement-breakpoint
CREATE INDEX `employee_sync_employee_id_idx` ON `employees_syncs` (`employee_sync_employee_id`);--> statement-breakpoint
CREATE TABLE `employees_salary_records`
(
    ...
    FOREIGN KEY (`employee_salary_record_employee_id`) REFERENCES `employees` (`employee_id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE INDEX `employee_salary_record_employee_id_IDX` ON `employees_salary_records` (`employee_salary_record_employee_id`);--> statement-breakpoint
...
CREATE INDEX `sales_group_name_unique_idx` ON `sales_groups` (`sales_group_name`);--> statement-breakpoint
CREATE TABLE `items`
(
...
CREATE INDEX `client_payment_organization_id_fk_idx` ON `clients_payments` (`client_payment_organization_id`);